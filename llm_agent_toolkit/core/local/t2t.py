...
class T2T_OLM_Core(Core, OllamaCore, ToolSupport):
    """
    `T2T_OLM_Core` is a concrete implementation of the `Core` abstract base classes `Core` and `ToolSupport`.
    ...
    async def run_async(
        ...
        * Early Termination Condition:
        ...
        number_of_primers = len(msgs)  # This is skip the preloaded messages
